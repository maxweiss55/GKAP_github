...
agg %>%
  ...
  theme(axis.text.x = element_text(angle = 90, hjust = 1)) +
  labs(title = "Average Favorability Score by Party ID", caption = "Important Note: A higher ordinal value denotes less willingness to contribute to a DNA to a biobank") +
